        ...
        <div class="row mt-4">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input name="txtpassword" type="password" class="form-control" id="txtpass" placeholder="Password">
                </div>
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" onclick="password()">
...
<script>
    function password(){
        ...
        var passwordStatus = document.getElementById("txtpass");
